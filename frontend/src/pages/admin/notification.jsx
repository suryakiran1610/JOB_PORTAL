...
function Notification() {
  ...
  useEffect(() => {
    MakeApiRequest(
      "get",
      `${config.baseUrl}adminn/getallcompanynotification/`,
      headers,
      {},
      {}
    )
  ...
  const deletecompany = () => {
    ...
    MakeApiRequest(
      ...
      .then((response) => {
        ...
        setCompanyData((prevCompanyData) =>
          prevCompanyData.filter((company) => company.company_user_id !== companyid)
          );
      })
                ...
                <div key={index}>
                  {notification.notificationtype === "registration" ? (
                    ...
                    >
                      ...
                      <div className="focus:outline-none cursor-pointer flex w-3/5 justify-end" onClick={() => {
