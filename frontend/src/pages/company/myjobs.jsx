...
function Myjobs() {
  ...
  const handleSearch = (e) => {
    ...
    if (startDate && endDate) {
      ...
      setErrorMessage("Add Start and End Date")
      setTimeout(() => {
        setErrorMessage("")
      }, 2000);
    }
  ...
  return (
    <>      
      ...
      {isloading ? (
        ...
        <div
          className="w-full h-screen px-4 py-1 sm:px-6 lg:px-8 lg:py-1 mx-auto "
          style={{ backgroundColor: "#EEEEEE" }}
        >
          <div className="max-w-[75rem] h-screen px-4 py-1 sm:px-6 lg:px-8 lg:py-1 mx-auto overflow-auto">
            <div>
            <div className="flex items-center justify-center p-4 ">
              <form className="bg-white shadow-xl flex flex-col lg:flex-row md:flex-col w-full max-w-2xl border mt-5 rounded-xl overflow-hidden items-center space-y-2 md:space-y-0">
                      ...
                      <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                        {jobs.map((job, index) => (
                          ...
                          >
                            ...
                            <td className="size-px whitespace-nowrap">
                              <div
                                className="relative inline-block px-20 py-2"
                                onMouseLeave={() => {
                                  setShowDropdown(false);
                                }}
                              >
