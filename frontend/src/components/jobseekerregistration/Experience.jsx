  ...
  return (
    <>
      <div className="px-4 py-1 sm:px-6 lg:px-8">
        <div className=" text-center text-2xl font-bold mb-1">Experience</div>
        <div className="flex flex-col lg:flex-row justify-evenly">
          <div className="flex flex-1 flex-col p-1 lg:pr-8">
            <div className="text-center font-bold text-blue-800 mb-3">
              Add Experience
            </div>
            ...
            <div className="flex flex-col w-full sm:w-64">
              <label className="flex flex-col gap-1 text-xs  mb-2">
                ...
                <input
                  ...
                  required
                  className="border border-gray-300 w-full h-8 ml-2"
                />
                {errors.job_title && (
              ...
              <label className="flex flex-col gap-1 text-xs  mb-2">
                ...
                <textarea
                  ...
                  onChange={HandlePesronalInfo}
                  required
                  className="border border-gray-300 w-full h-24 ml-2"
                />
                ...
                <label className="flex flex-col gap-1 text-xs w-full mb-2">
                  From
                  <input
                    type="date"
                    name="from_date"
              ...
              <input
                ...
                required
                className="education-choose-file mt-1 ml-1 w-full"
                accept="image/jpeg, image/png"
                name=""
                id=""
              />
              {errors.experience_document && (
                <span className="error-message text-red-700 block px-6 w-fit mt-1 text-xs">
                  {errors.experience_document}
                </span>
              )}
              <button
                ...
                type="button"
                className="mt-6 gap-4 mb-6 flex px-6 py-2 text-white bg-slate-800 hover:bg-slate-900 items-center mx-auto"
              >
          ...
          <div className="flex flex-1 flex-col p-1">
            ...
            {experienceData &&
              experienceData.map((experience, index) => (
                <div
                  className="text-left mb-4 bg-white p-3 border border-gray-200 rounded-md shadow-sm"
                  key={index}
                >
        ...
        <div
          className="w-28 px-5 py-2 mt-1 text-white cursor-pointer mx-auto sm:mx-0"
