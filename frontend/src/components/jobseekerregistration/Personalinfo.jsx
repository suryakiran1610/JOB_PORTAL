    ...
    <div className="flex justify-evenly pt-10 max-sm:flex-col-reverse max-sm:justify-normal max-sm:pt-3">
      <div className="flex flex-col gap-2 max-sm:p-8 ml-5">
        ...
        <label className="flex flex-col mb-1 gap-1 text-xs">
          ...
          <div className="flex gap-2">
            <input
              type="text"
              defaultValue="+91"
              className="border border-gray-300 w-14 h-8 p-2"
            />
            <input
              type="tel"
              name="mobile"
              ...
              onChange={HandlePesronalInfo}
              className="border border-gray-300 flex-1 h-8 p-2"
            />
          </div>
          {errors.mobile && (
            <span className="error-message text-red-700">
        ...
        <div className="flex flex-wrap gap-2">
          <label className="flex flex-col mb-1 gap-1 text-xs flex-1">
            City
            <input
              type="text"
              name="city"
        ...
        <button
          className="px-4 py-2 mt-6 text-white bg-red-700"
