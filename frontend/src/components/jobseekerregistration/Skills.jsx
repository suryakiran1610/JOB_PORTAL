    ...
    <>
      {isloading ? (
        ...
        <form
          ...
          className="flex flex-col items-center p-4 max-w-xl mx-auto"
        >
          {/* Header */}
          <div className="text-center text-2xl font-bold mt-5 mb-5">
            Add Job Details
          </div>
          ...
          <div className="w-full">
            <div className="tag-input-container text-base font-semibold mb-5">
              ...
              {errors.tags && (
                <span className="error-message text-red-700 mt-2">
                  {errors.tags}
                </span>
              )}
            </div>
